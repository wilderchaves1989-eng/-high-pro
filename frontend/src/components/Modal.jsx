...
export default function Modal({ open, onClose, title, children, maxWidth = 560 }) {
  ...
  return (
    ...
    >
      <div style={{ background: 'var(--surface)', borderRadius: 12, boxShadow: '0 8px 24px rgba(0,0,0,0.08)', width: '100%', maxWidth, maxHeight: '85vh', overflowY: 'auto' }}>
        <div style={{ padding: '20px 24px', borderBottom: '1px solid var(--border)', display: 'flex', alignItems: 'center', justifyContent: 'space-between', position: 'sticky', top: 0, background: 'var(--surface)', zIndex: 1, borderRadius: '12px 12px 0 0' }}>
